...
<h3 class="page-title">Filling Form</h3>
<div class="container-wrapper">
	<div class="row">
		<div class="col-md-12">
			<button class="btn btn-success pull-right" data-toggle="modal" data-target="#modalInsert"><i class="fa fa-plus"></i> Add Item</button>
		</div>
	</div><br>
	<div class="row">
		<div class="col-md-2">
